((from ocurrent/opam@sha256:27504372f75c847ac82eecc4f21599ba81647d377f844bde25325d6852a65760)
 ...
 (run
  (shell
   "cd ~/opam-repository && (git cat-file -e 9f2b866093e41bae017292155e8f2cf85889a027 || git fetch origin master) && git reset -q --hard 9f2b866093e41bae017292155e8f2cf85889a027 && git log --no-decorate -n1 --oneline && opam update -u"))
 (run (shell "mkdir -p \"ocurrent/\" \"ocluster/\" \"./\""))
 (copy
  (src
   ocurrent/current_web.opam ocurrent/current_slack.opam
   ocurrent/current_rpc.opam ocurrent/current_incr.opam
   ocurrent/current_github.opam ocurrent/current_git.opam
   ocurrent/current_examples.opam ocurrent/current_docker.opam
   ocurrent/current_ansi.opam ocurrent/current.opam)
  (dst ocurrent/))
 (copy
  (src
   ocluster/ocluster.opam ocluster/ocluster-api.opam
   ocluster/current_ocluster.opam)
  (dst ocluster/))
 (copy
  (src
   ocaml-ci-web.opam ocaml-ci-solver.opam ocaml-ci-service.opam
   ocaml-ci-client.opam ocaml-ci-api.opam)
  (dst ./))
 (run
  (shell
