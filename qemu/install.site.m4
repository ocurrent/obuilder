...
/usr/local/bin/curl -L https://github.com/ocaml/opam/releases/download/2.5.0/opam-2.5.0-x86_64-openbsd -o /usr/bin/opam-2.5
chmod +x /usr/bin/opam-2.3
chmod +x /usr/bin/opam-2.4
chmod +x /usr/bin/opam-2.5
ln -s /usr/bin/opam-2.5 /usr/bin/opam
